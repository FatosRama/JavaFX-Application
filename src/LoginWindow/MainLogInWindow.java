...
//     -------------------------------------------------------------------
        ...
        exitButton.setStyle("-fx-background-color: black;"+"-fx-text-fill: #39ff14");
        ...
        root.getChildren().addAll(titleApplication,dLine1,dLine2,dLine3,right,bottom,left,top,exitButton);
